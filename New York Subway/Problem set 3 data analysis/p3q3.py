...
def mann_whitney_plus_means(turnstile_weather):
    ...
    without_rain_mean=np.mean(no_rain_data["ENTRIESn_hourly"])

    U,p=scipy.stats.mannwhitneyu(rain_data["ENTRIESn_hourly"],no_rain_data["ENTRIESn_hourly"])
...
data_file="../turnstile_data_master_with_weather.csv"
